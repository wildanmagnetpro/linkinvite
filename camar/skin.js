...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		els.innerHTML="TIPE CAMAR<br\/><br\/>60\/72<br\/>1 KAMAR TIDUR<br\/>1 KAMAR<br\/>FREE MEZANINE<br\/>";
		el.appendChild(els);
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		els.innerHTML="INFO LENGKAP<br\/>WHATSAPP CS";
		el.appendChild(els);
		...
		me._text_1.onclick=function (e) {
			player.openUrl("https:\/\/wa.me\/6283894553550","_self");
		}
